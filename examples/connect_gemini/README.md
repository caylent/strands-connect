...
The synthetic retail tools, result mapping, contact attributes, lifecycle, and optional tool sounds are identical to the OpenAI example. There is no provider-specific persistence code. Set `TOOL_CUE_ENABLED=false` to disable the earcon.
